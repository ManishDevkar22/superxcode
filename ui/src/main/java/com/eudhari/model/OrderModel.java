...
public class OrderModel {
    ...
    public OrderModel(String orderId, String customerId, String customerName, String shopId, String shopName,
                      String shopkeeperId, List<OrderItemModel> items, double totalAmount, String status,
    ...
    public static OrderModel fromDocumentMap(String docId, Map<String, Object> map) {
        if (map == null) return new OrderModel();

        String orderId = map.get("orderId") != null ? map.get("orderId").toString() : docId;
        ...
        return new OrderModel(orderId, customerId, customerName, shopId, shopName, shopkeeperId, itemList, totalAmount, status, createdAt, updatedAt);
    }
}
